...
var alug_chapters = {
	"P0.1 - Basics": [
		...
		{topic: "Alif vs Hamza", pageNo: 6},
		{topic: "همزة القطع vs همزة الوصل ", pageNo: 7},
		{topic: "التَجوِيد (Tajweed)", pageNo: 8}, 
	...
	"P2 - Nouns": [
		...
		{topic: "Sound and Irregular Plurals", pageNo: 9},
		{topic: "Adjectival Construction - النعت والمنعُوت", pageNo: 13},
		{topic: "Substitute - البدل", pageNo: 14},
		{topic: "Empathetic - التوكيد", pageNo: 15},
	...
	"P2.2 - Object Effects": [
		...
		{topic: "Adverbs of frequency (ظروف التكرار)", pageNo: 5},	
		{topic: "Adverbs of manner (الحال)", pageNo: 6},
		{topic: "The Causal Object المفعول لأجله / المفعول له", pageNo: 7},
		{topic: "The Comitative Object المفعول معه", pageNo: 8},
		{topic: "Circumstantial Adverb (الحال)", pageNo: 9},
		{topic: "Distinction (التمييز)", pageNo: 10},
	...
	"P3 - Verbs": [
		...
		{topic: "المعلوم - Active Voice", pageNo: 11}, 
		{topic: "المجهُول – Passive Voice", pageNo: 12}, 
		{topic: "Adequate  Verbs ( افعال التامّة )", pageNo: 13}, 
		{topic: "Inadequate Verbs ( الافعال الناقصة)", pageNo: 14}, 
		{topic: "Phrasal Verbs (أفعالُ المُركّبة )", pageNo: 15}, 
	...
	"P3.1 - Verb Conjugations": [
		...
		{topic: "Form I  - Defective (ناقص)", pageNo: 5}, 
	...
	"P4 - Sentences": [
		...
		{topic: "Two-Verb Combinations", pageNo: 18}, 
		{topic: "نُونُ الوِقايَة and  ياءُ المُتكلِّم and ياءُ المُخاطبة", pageNo: 19}, 
	...
	"P5 - Particles": [
		...
		{topic: "أَنْ  vs أَنَّ vs  إِنَّ", pageNo: 7}, 
		{topic: "Uses of  ل", pageNo: 8}, 
		{topic: "Uses of لا", pageNo: 9}, 
		{topic: "Uses of  ما", pageNo: 10}, 
		{topic: "Uses of  إِن", pageNo: 11}, 
		{topic: "Uses of  و", pageNo: 12}, 
		{topic: "Uses of  إذ /  إذا", pageNo: 14}, 
		{topic: "Uses of قبلُ (بعد, etc.)", pageNo: 15}, 
		{topic: "Uses of مِن قِبَلِ", pageNo: 16}, 
...
var knowledge_checks = [
	...
	{
		ch: "P4 - Sentences", 	topic: "	",  pageNo: 20
	}
];