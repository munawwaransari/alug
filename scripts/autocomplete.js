...
function refreshAutoCompleteList(inp, val, arr){
...
function autocomplete(inp, refreshCallback) {
  ...
  inp.addEventListener("input", function(e) {
      ...
      closeAllLists();
      if (!val) { return false;}
	  if(refreshCallback && refreshCallback(val, function(arr2){
		currentFocus = -1;
		refreshAutoCompleteList(inp, val, arr2);  
	  }));
  });
